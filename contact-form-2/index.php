...
<head>
	...
	<link rel="stylesheet" href="contact-form-2/css/reset.css"> <!-- CSS reset -->
	<link rel="stylesheet" href="contact-form-2/css/style.css"> <!-- Resource style -->
	<script src="contact-form-2/js/modernizr.js"></script> <!-- Modernizr -->
  	
	<title>Lauren Lopatko - Contact</title>
</head>
<body>
	<form class="cd-form floating-labels" action="" method="post"> <!-- Added Action and Methos to the form. -->
		<fieldset>
			<legend>What's your idea?</legend>
			<?php
...
<script src="contact-form-2/js/jquery-2.1.1.js"></script>
<script src="contact-form-2/js/main.js"></script> <!-- Resource jQuery -->
</body>
</html>